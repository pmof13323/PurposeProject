    ...
    for attempt in range(4):
        try:
            ...
            completion = client.chat.completions.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": "You are an assessor, your job is to assign a score between 1 and 10 for each of the Big 5 personality traits provided based on the text given"},
